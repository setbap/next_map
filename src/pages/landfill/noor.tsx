    ...
    <>
      <Head>
        ...
        <meta
          ...
          content={"معرفی لندفیل نور به همراه ویدیو و عکس "}
        />
            ...
            <div className=" w-full mt-4 mx-auto text-center rounded-xl flex-wrap md:flex-nowrap flex-row  flex ">
              <div className="w-full md:w-1/2 mx-2 text-center rounded-xl">
                <div className="aspect-w-16 aspect-h-9  overflow-hidden bg-black  rounded-lg shadow-lg">
                  <img src="/landfill/noor/noor.jpg" className="object-fill" />
                </div>
              </div>
            ...
            <div className=" w-full mx-auto text-center rounded-xl flex-wrap md:flex-nowrap flex-row  flex ">
              <div className="w-full md:w-4/12 md:mb-0 mb-4  mx-2 text-center rounded-xl">
                <div className="aspect-w-8 aspect-h-9  rounded-lg shadow-lg">
                  <iframe
                    ...
                    src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d2013.619385813534!2d52.05923366226977!3d36.4783568511398!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2s!4v1621787025174!5m2!1sen!2s"
                    loading="lazy"
                  ></iframe>
                </div>
              </div>
              ...
              <div className=" bg-skin-card w-full  rounded-lg md:w-8/12   font-extrabold shadow-lg">
                <div className="aspect-w-16 aspect-h-9  rounded-lg shadow-lg">
                  <iframe
                    src="https://www.aparat.com/video/video/embed/videohash/v6fcG/vt/frame"
              ...
              <AnimatePresence>
                {infoState === LandFillInfoState.Moarefi && (
                  <motion.div className=" w-full ">
                    ...
                    >
                      <h2>معرفی لندفیل نور </h2>
                      <p className="">
                        نور از شهرهای بزرگ واقع در بخش مرکزی استان مازندارن است.
                        این شهر با مساحت 2675 کیلومترمربع جمعیتی افزون بر 50000
                        نفر دارد. این شهرستان دارای 5 شهر (نور، بلده، رویان،
                        چمستان، ایزدشهر) 3 بخش (مرکزی، بلده، چمستان) 8 دهستان و
                        226 آبادی است. ۱۵۰ تن زباله روزانه تولیدی در این شهر در
                        جنوب شهرستان در منطقه ی نصرت آباد و در میان عرصه های بکر
                        جنگلی به روش تلمبار سطحی دفع می شود. این مکان در 10
                        کیلومتری جنوب شهر در حدود 20 سال است که پذیرنده زباله
                        های تولیدی در شهرستان نور است.
                      </p>
                    </motion.div>
                      ...
                      <div className="col-span-4 md:col-span-2 ">
                        ...
                        >
                          <iframe
                            ...
                            allowFullScreen
                            src="https://www.aparat.com/video/video/embed/videohash/SHBLc/vt/frame"
                            title="تایم لپس محل دفن زباله های نور"
                          />
                        </InfoCard>
                      </div>
                      <div className="col-span-4 md:col-span-2 ">
