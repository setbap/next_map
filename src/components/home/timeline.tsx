    ...
    <div className="container mx-auto my-12">
      <div className=" bg-skin-card dark:bg-gray-800 py-8 rounded-lg shadow">
        ...
        <div className="timeline relative mx-auto max-w-7xl md:p-4 ps-4">
          ...
          <TimeLineContent
            title="9 آذر"
            subTitle="هسته پژوهشی ما با حمایت مستقیم بنیاد ملی نخبگان استان مازندران تحت عنوان طرح شهید احمدی روشن متولد شد."
          />
          <TimeLineContent
            title="16 آذر"
          ...
          <TimeLineContent
            title="19 فروردین"
            subTitle="با  و ثبت دامنه سایت بارگزاری اطلاعات مرتبط با لندفیلهای استان انجام گرفت. هسته NITEnviro در جستجوی اطلاعات به هر مقاله، گزارش و محل دفن زباله ای در استان سر زده تا داده های مستند را پیدا و در بانک اطلاعاتی خود ثبت و ارائه کند"
          />
          <TimeLineContent
            title="1 اردیبهشت"
